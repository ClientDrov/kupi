        ...
        <div class="wrapper">
            <div class="block block__path">
                <div class="input__path">
                    ...
                    <div class="dropdown_block" v-if="from.show && from.search.length > 0">
                        <ul>
                            <li v-for="item in from.search" :key="item.code" @click="select_from(item.city, item.code)">
                ...
                <div class="input__path">
                    ...
                    <div class="dropdown_block" v-if="to.show && to.search.length > 0">
                        <ul>
                            <li v-for="item in to.search" :key="item.code" @click="select_to(item.city, item.code)">
                                <div class="row__search">
                                    <div class="row__data">
                                        <div class="row__title">{{ item.city }}</div>
                                        <div class="row__description">{{ item.country }}</div>
            ...
            <div class="block block__search">
                <div class="block block__date">
                    ...
                    <div class="input__date">
                        <input type="text" id="dateReturn" class="input__search return" placeholder="Return" />
                    </div>
                </div>
                <div class="block block__options">
                    <div class="input__wrapper">
                        <div class="">
                            <div class="block input__search input__options" @click="option_show = !option_show">
                                        ...
                                        <div class="options__row">
                                            ...
                                            <div class="count__button">
                                                <img
                                                    ...
                                                    @click="minusAdults()"
                                                />
                                                <img src="../assets/img/plus.svg" class="option_plus" @click="plus('adults')" />
                                            </div>
                                        </div>
                                    </div>
                                    <div class="droped__row">
                                        ...
                                        <div class="options__row">
                                            ...
                                            <div class="count__button">
                                                ...
                                                />
                                                <img src="../assets/img/plus.svg" class="option_plus" @click="plus('children')" />
                                            </div>
                                        </div>
                                    </div>
                                    <div class="droped__row">
                                        ...
                                        <div class="options__row">
                                            ...
                                            <div class="count__button">
                                                ...
                                                />
                                                <img src="../assets/img/plus.svg" class="option_plus" @click="plus('infants')" />
                                            </div>
                                        </div>
                                    </div>
                                    <div class="droped__row">
                                        <label class="select_class"
                                            ><span class=""
                                                ><input type="checkbox" name="" v-model="business" class="checkbox" /></span
                    ...
                    <div>
                        <button type="button" @click="search()" class="search__button">Search</button>
                    </div>
                </div>
            </div>
        </div>
...
import { getCountry, getUserCityByIP } from "@/plugins/requests.js";
...
export default {
    ...
    methods: {
        ...
        plus(e) {
            if (this.options.adults + this.options.children + this.options.infants < 9) this.options[e]++;
        },
            ...
            if (this.from.code.length > 1) {
                if (this.to.code.length > 1) {
                    ...
                    if (depart.length > 1) {
                        ...
                        if (this.$router.currentRoute._rawValue.name === "Tickets") location.reload();
                    } else {
    ...
    mounted() {
        new AirDatepicker("#dateDepart", {
            ...
            selectedDates: localStorage.getItem("depart") || "",
            locale: localeEn,
        });
        new AirDatepicker("#dateReturn", {
            ...
            buttons: [
                {
                    content: "No return ticket needed",
                    className: "date__btn",
                    onClick(dp) {
                        dp.hide();
                    },
    ...
    async create() {
        const userData = await getUserCityByIP();
        if (userData) {
            this.from.value = userData.city;
            this.from.code = userData.code;
        }
    },
};
</script>
