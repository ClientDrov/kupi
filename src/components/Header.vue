<template>
  ...
  _smartsupp.key = '6c583d12143c1c5b15781cc7312030af97d1ed66';
          ...
          <div class="drop__block left_line">
            ...
            >
              <span class="drop__item"
                ><img :src="item.icon" class="img_lang" />{{ item.title }}</span
              >
