                ...
                <div class="fare__container">
                    ...
                    <div class="fare__item_cont">
                        <div class="fare__item selected">
                            ...
                            <button class="fare__item-btn selected" type="button">Selected</button>
                        </div>
                        ...
                        <div class="fare__item">
                            ...
                            <button class="fare__item-btn" type="button">Select</button>
                        </div>
                    ...
                    <div class="info__forms">
                        <div class="info__input">
                            ...
                            <div class="input__wrapper">
                                <input type="text" placeholder="Email" autocomplete="no" class="input" value="" />
                            </div>
                        </div>
                        <div class="info__input p-10">
                            <label for="null" class="info__label">Phone number</label>
                            <div class="input__wrapper">
                                <input type="text" placeholder="Phone number" autocomplete="no" class="input" value="" />
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="info__content">
                    <div class="info__forms">
                        <div class="info__input">
                            ...
                            <div class="input__wrapper">
                                <input type="text" placeholder="John" autocomplete="no" class="input" value="" />
                            </div>
                        </div>
                        <div class="info__input p-10">
                            <label for="null" class="info__label">Last name</label>
                            <div class="input__wrapper">
                                <input type="text" placeholder="Smith" autocomplete="no" class="input" value="" />
                            </div>
                        </div>
                    </div>
                    <div class="info__forms">
                        <div class="info__input">
                            ...
                            <div class="input__wrapper">
                                <input type="text" placeholder="Day" autocomplete="no" class="input" value="" />
                                ...
                                <input type="text" placeholder="Year" autocomplete="no" class="input" value="" />
                            </div>
                        </div>
                        <div class="info__input p-10">
                            <label for="null" class="info__label">Sex</label>
                            <div class="input__wrapper">
                                <input type="text" placeholder="Male" autocomplete="no" class="input" value="" />
                            </div>
                        </div>
                    </div>
                    <div class="info__forms">
                        <div class="info__input">
                            ...
                            <div class="input__wrapper">
                                <input type="text" placeholder="" autocomplete="no" class="input" value="" />
                            </div>
                        </div>
                        <div class="info__input">
            ...
            <div class="booking_cont container__info">
                <div>
                    ...
                    <div class="booking_btn_cont">
                        <a href="https://www.booking.com/" class="booking_btn">Choose a hotel</a>
            ...
            <div class="confirm">
                <div class="confirm_prices">
                    <div class="confirm_price">
                        ...
                        <div class="price">{{ currency }}{{ this.$route.params.price }}</div>
                    </div>
                    <button
                        type="button"
                        class="confirm_submit"
                        @click="
                            this.$router.push({
                                name: 'Payment',
                                params: {
...
export default {
    ...
    mounted() {
        document.title = `${moment(this.$route.params.time).format("dddd, MMMM DD")}, ${this.$route.params.depar} → ${
            this.$route.params.return
        }`;
    },
};
