    ...
    <form action="" class="form">
      ...
      <div class="container__info">
        ...
        <div class="fare__container">
          ...
          <div class="fare__alert">
            <div class="fare__alert-title">
              Luggage can only be added in fares
            </div>
            <div class="fare__alert-descr">
              There is no option to add luggage on this flight. Please bear this
              in mind when selecting your fare
            </div>
          </div>
      ...
      <div class="container__info">
        ...
        <div class="info__content" style="border-top: none; margin-top: -20px">
          <span class="flight_details__descr">
            We will send your ticket by email, send notifications about flight
            ...
            <div class="info__input">
              ...
              <div class="input__wrapper">
                <div class="input-container">
                  ...
                  />
                  <div class="error-text" v-if="form.email.error">
                    Required field
                  </div>
                </div>
              </div>
            ...
            <div class="info__input p-10">
              ...
              <div class="input__wrapper">
                <div class="input-container">
                  ...
                  />
                  <div class="error-text" v-if="form.phone.error">
                    Required field
                  </div>
                </div>
              </div>
      ...
      <div class="container__info">
		...
		s-19.4-7.7-20.7-19.8L237,158.6c-1.3-13.1,5.801-23,18-23H299.1C311.3,135.7,318.5,145.6,317.2,158.7z"
            ...
            <span>
              The number of passengers for this airline can only be changed with
              a new search
            </span>
          </div>
        </div>
          ...
          <div class="info__forms">
            <div class="info__input">
              ...
              <div class="input__wrapper">
                <div class="input-container">
                  ...
                  />
                  <div class="error-text" v-if="form.firstName.error">
                    Required field
                  </div>
                </div>
              </div>
            ...
            <div class="info__input p-10">
              ...
              <div class="input__wrapper">
                ...
                <div class="error-text" v-if="form.lastName.error">
                  Required field
                </div>
              </div>
            </div>
            ...
            <div class="info__input">
              ...
              <div class="input__wrapper">
                <div class="input-container" style="margin-right: 10px">
                  ...
                  />
                  <div class="error-text" v-if="form.DateDay.error">
                    Day is not valid
                  </div>
                </div>
                <div class="input-container" style="margin-right: 10px">
                  ...
                  />
                  <div class="error-text" v-if="form.DateMonth.error">
                    Month is not valid
                  </div>
                </div>
                <div class="input-container">
                  ...
                  />
                  <div class="error-text" v-if="form.DateYear.error">
                    Year is not valid
                  </div>
                </div>
              </div>
            ...
            <div class="info__input">
              ...
              <div class="input__wrapper">
                <div class="input-container">
                  ...
                  />
                  <div class="error-text" v-if="form.Passport.error">
                    Required field
                  </div>
                </div>
              </div>
            ...
            <div class="info__input">
              ...
              <div class="input__wrapper">
                <div class="input-container">
                  ...
                  />
                  <div class="error-text" v-if="form.Until.error">
                    Required field
                  </div>
                </div>
              </div>
      ...
      <div class="booking_cont container__info">
        <div>
          ...
          <div class="booking_text">
            ...
            Find the right accommodation in advance and book with ease at
            Booking.com
          </div>
          <div class="booking_btn_cont">
            <a
              ...
              >Choose a hotel</a
            >
            <div class="bookeing_btn_descr">
              Choose today so there's something nice to think about tomorrow!
            </div>
          </div>
        </div>
      ...
      <div class="confirm">
        <div class="confirm_prices">
          ...
          <button type="button" class="confirm_submit" @click="confirm">
            Go to payment
          </button>
        </div>
      </div>
